...
<body id="f100d" <?php body_class( 'intro-transition' ); ?>>
    <header class="header <?php echo (is_page('First 100 Days - Biden') ? 'is-page' : 'is-single'); ?>">
        ...
        <div class="full-screen-menu">
            <div class="container is-fluid">
                <div class="columns">
                    <div class="column">
                        <div class="menu">
                            <p class="menu-label">First 100 Days - Biden</p>
                            <ul class="menu-list">

                            <?php lawreview_get_posts_by_category_id( 198, 2 ); ?>
        ...
        <?php if ( ! is_page('First 100 Days - Biden') ): ?>
            <div class="nav-center">
                <div class="nav-item">
                    <a href="<?php echo get_permalink( 4965 ); ?>">President Biden’s First 100 Days: A Symposium</a>
                </div>
            </div>
        <?php endif; ?>
